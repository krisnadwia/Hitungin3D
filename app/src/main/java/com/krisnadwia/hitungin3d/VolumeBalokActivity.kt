...
class VolumeBalokActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        editPanjang = findViewById(R.id.edit_text_volume_balok_panjang)
        editLebar = findViewById(R.id.edit_text_volume_balok_lebar)
        editTinggi = findViewById(R.id.edit_text_volume_balok_tinggi)
        btnHitung = findViewById(R.id.btn_hitung_volume_balok_hasil)
        btnHapus = findViewById(R.id.btn_hapus_volume_balok_hasil)
        tvHasil = findViewById(R.id.tv_hasil_volume_balok)
    ...
    override fun onClick(p0: View?) {
        if (p0?.id == R.id.btn_hitung_volume_balok_hasil) {
        ...
        if (p0?.id == R.id.btn_hapus_volume_balok_hasil) {
            editPanjang.setText("")
            editLebar.setText("")
            editTinggi.setText("")
